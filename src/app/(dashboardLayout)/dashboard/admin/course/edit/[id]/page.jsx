...
const EditCourse = () => {
  ...
  // CSS Classes
  const inputClass = "w-full px-4 py-2 rounded-lg border border-slate-200 focus:ring-2 focus:ring-[#f79952]/20 outline-none text-[13px] bg-white transition-all";
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (fetchedCourse) {
          const formattedData = {
            ...fetchedCourse,
            // পপুলেটেড অবজেক্ট থেকে শুধু আইডি আলাদা করা ড্রপডাউনের জন্য
